...
set cursorline " show a horizontal highlight on the line with the cursor

set hlsearch " activate highlighting search pattern matches & incremental search

set incsearch

set wrap 
set linebreak " set line wrapping and line break for easy text-file editing 

set ignorecase
set smartcase  " activate case-insensitive & smart case search 
